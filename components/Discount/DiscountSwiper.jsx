...
function DiscountSwiper({ discounted }) {
  return (
    <div className="flex flex-row items-center md:gap-12 p-2 md:p-20 ">
      <div className="flex flex-col items-center justify-center gap-3 h-70 p-1 rounded-l-3xl bg-[#9e0910] text-white">
      ...
      <Swiper
        ...
        className="flex-1 w-full bg-[#9e0910] h-70 rounded-r-3xl border-r-2 border-[#9e0910] p-6 md:p-12 shadow-xl"
      >
