...
function Footer() {
  return (
    <footer className="bg-red-950 text-white py-7 px-6 md:px-auto">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10">
        {/* About */}
        <div>
          <h3 className="text-xl font-bold mb-2 md:mb-4">foody</h3>
        ...
        {/* Quick Links */}
        <div>
          <h3 className="text-lg font-bold mb-2 md:mb-4">Quick Links</h3>
        ...
        <div id="contact">
          ...
          <p className="text-xs md:text-sm text-gray-300">+1 (234) 567-890</p>
          <p className="text-xs md:text-sm text-gray-300">info@foody.com</p>
        </div>
      ...
      {/* Copyright */}
      <div className="mt-4 text-xs md:text-sm text-center text-gray-500">
