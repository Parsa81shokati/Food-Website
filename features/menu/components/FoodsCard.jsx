...
import { addItem, removeItem } from "@/features/cart/cartSlice.js.jsx";
  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center h-64 md:h-72 w-44 md:w-56 bg-white rounded-2xl md:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-[#9e0910]/30 pt-14 md:pt-16">
        ...
        <div
          className={`absolute inset-0 pointer-events-none bg-gradient-to-t from-[#9e0910]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
        />
        ...
        {food.isDiscounted && (
          <div className="absolute -top-2 -right-2 z-20">
            <div className="relative">
              <div className="bg-gradient-to-r from-[#9e0910] to-[#c20e17] text-white text-xs font-bold px-3 py-2 rounded-full shadow-[0_0_18px_rgba(158,9,16,0.5)] flex flex-col items-center leading-tight">
        ...
        <div className="absolute -top-10 md:-top-12 left-1/2 -translate-x-1/2">
          {/* دایره بیرونی */}
          <div
            className={`w-24 h-24 md:w-27 md:h-27 rounded-full bg-gradient-to-br from-[#9e0910] to-[#c20e17] transition-all duration-300 ${isHovered ? "scale-105" : "scale-100"} flex items-center justify-center shadow-xl`}
          >
