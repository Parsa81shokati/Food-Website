            ...
            <div className="flex items-center w-40 ">
              {!cartItem ? (
                <button
                  ...
                  className="w-full h-10 px-5 flex items-center justify-center gap-1.5 bg-gradient-to-r from-[#9e0910] to-[#c20e17] text-white text-sm rounded-full font-medium hover:shadow-lg hover:scale-105 transition-all duration-300"
                >
                  <MdShoppingCart className="text-xl" />
                  Add to Cart
                </button>
              ) : (
                <div className="w-full h-10 flex items-center justify-between bg-gradient-to-r from-[#9e0910] to-[#c20e17] text-white rounded-full px-2 gap-1">
                  <button
                    onClick={() => dispatch(removeItem(food))}
                    className="w-7 h-7 flex items-center justify-center hover:bg-white/20 rounded-full transition"
                  >
                    <FaMinus size={11} />
                  </button>
