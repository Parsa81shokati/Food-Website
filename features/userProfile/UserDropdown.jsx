...
function UserDropdown({ user, onLogout }) {
  ...
  // آیتم‌های منو (Profile در بالای لیست قرار گرفته)

  // فیلتر آیتم‌ها (در صورت نیاز به role)
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={`group relative flex items-center gap-2 md:gap-2.5 px-2 md:px-3 py-1.5 md:py-2 bg-gradient-to-r from-[#9e0910] to-[#c20e17] text-white rounded-full transition-all duration-300 hover:shadow-lg ${
